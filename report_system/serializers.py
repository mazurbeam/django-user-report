...
class CreateTicketSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        if content_type in settings.REPORT_SLUG_MODEL_MAPPINGS:
            content_type = settings.REPORT_SLUG_MODEL_MAPPINGS[content_type]
    ...
    def create(self, validated_data):
        ...
        if Ticket.objects.for_model(self.target_object).count() > settings.HIGH_PRIORITY_TICKETS_NUM:
